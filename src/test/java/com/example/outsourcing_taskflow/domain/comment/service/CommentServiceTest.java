...
class CommentServiceTest {
    ...
    void getComments_댓글과_대댓글_계층구조로_조회할_수_있다_success() {
        ...
        List<CommentDto> allComments = Arrays.asList(
                // 부모 댓글 1 (가장 오래된)
                new CommentDto(
        ...
        // when
        Page<CommentDto> result = commentService.getComments(taskId, pageable);
