package com.example.outsourcing_taskflow.domain.task.model.response;
...
import com.example.outsourcing_taskflow.domain.task.model.dto.AssigneeInfo;
...
public class UpdateTaskStatusResponse {
    ...
    public static UpdateTaskStatusResponse from(Task task) {
